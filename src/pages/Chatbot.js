...
•Lưu ý: [Trả lời]`;
  ...
  <div className="box section-b" style={{ whiteSpace: 'pre-wrap', marginTop: '20px', backgroundColor: 'white' }}>
    ...
    <h3 className="section-title">Giám sát và chăm sóc (Bắt đầu từ {scheduleDates[0]})</h3>
        ...
        <p style={{marginLeft:'20px'}}>Lưu ý : Khí hậu Hà Nội mùa hè nắng nóng, cần chú ý tưới nước thường xuyên, đặc biệt trong những ngày nắng gắt. Theo dõi cây thường xuyên để phát hiện xử lý kịp thời</p>
  </div>
)}
      {/* Khối B */}
